      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          <div className="text-center md:text-left">
            <h2 className="text-xl font-bold text-slate-900">JobPortal</h2>
            <p className="text-sm text-slate-500">© 2026 JobPortal Inc. All rights reserved.</p>
          </div>
          
          <div className="mt-2 flex space-x-4 md:mt-0">
            <a href="https://facebook.com" className="text-slate-500 transition hover:text-violet-600" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="text-slate-500 transition hover:text-violet-600" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="text-slate-500 transition hover:text-violet-600" aria-label="LinkedIn">
